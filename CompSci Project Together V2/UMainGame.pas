...
uses
  ...
  System.Bindings.Outputs, Vcl.Bind.Editors, Data.Bind.Components, Math, UGameOver;
...
type
    ...
    var
      ...
      function CollisionCheck(SpaceshipXLow, SpaceshipYLow, SpaceshipXHigh, SpaceshipYHigh, AsteroidLeft, AsteroidTop : integer) : boolean;
...
type TCreateAsteroidThread =  class(TThread)
  ...
  procedure TCreateAsteroidThread.CreateAsteroid;
    begin
      ...
      if Num = 1 then
        begin
          Asteroid.Picture.LoadFromFile('E:\CompSci Release Ver\CompSci Release Ver\CompSci Project Together V2\Asteroid Sprites\5.png')
        end
      else if Num = 2 then
        begin
          Asteroid.Picture.LoadFromFile('E:\CompSci Release Ver\CompSci Release Ver\CompSci Project Together V2\Asteroid Sprites\5.png')
      ...
      begin
        ...
        for I := 0 to (AsteroidNum + 1) do
          begin
            ...
            MainGameForm.Score := MainGameForm.Score + 10;
          end;
      end;
  end;
  ...
  function CollisionCheck(SpaceshipXLow, SpaceshipYLow, SpaceshipXHigh, SpaceshipYHigh, AsteroidLeft, AsteroidTop : integer) : boolean;
    ...
    var Xa, Ya, A, B, I, Z, AsteroidHighX, AsteroidLowX, AsteroidHighY, AsteroidLowY : integer;
  ...
  begin
    ...
    SpaceshipXHigh := (SpaceshipXLow + 105);
    SpaceshipYLow := MainGameForm.imgShipFrameFocus.Top;
    SpaceshipYHigh := SpaceshipYLow + 105;
